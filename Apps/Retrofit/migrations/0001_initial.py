    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_seismic_resistance', models.CharField(max_length=255)),
                ('retrofit_strategy', models.TextField()),
                ('retrofitting_materials', models.TextField()),
                ('expected_performance_level', models.CharField(max_length=255)),
                ('estimated_cost', models.DecimalField(decimal_places=2, max_digits=15)),
                ('retrofit_design_file', models.FileField(blank=True, null=True, upload_to='retrofitting/designs/')),
