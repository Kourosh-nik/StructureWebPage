    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_status', models.CharField(choices=[('Planning', 'برنامه\u200cریزی'), ('Ongoing', 'در حال اجرا'), ('Completed', 'تکمیل\u200cشده')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField()),
                ('video', models.FileField(blank=True, null=True, upload_to='proj/video')),
                ('latitude', models.FloatField(blank=True, null=True)),
                ('longitude', models.FloatField(blank=True, null=True)),
                ('pdf', models.FileField(blank=True, null=True, upload_to='proj/pdf')),
